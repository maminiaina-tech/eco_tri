...
\begin{titlepage}
    \begin{center}
        \vspace*{1cm}
        \includegraphics[width=0.3\textwidth]{results/training_curves.png}\\
        \vspace{1cm}
        {\Huge \textbf{Eco-Tri}}\\
        \vspace{0.5cm}
...
\begin{center}
\url{https://github.com/Maminiaina0601/eco_tri.git}
\end{center}
...
# Cloner le depot
git clone https://github.com/Maminiaina0601/eco_tri.git
cd eco-tri
